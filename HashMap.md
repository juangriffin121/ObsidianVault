...
The HashMap is a key-value pair data structure that uses the hash function to relate the key data to the address of the value in memory. examples of it are rusts HashMap and python's dictionary.
