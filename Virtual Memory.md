...
A program's virtual memory is usually separated into [[heap]], [[stack(memory)]] and [[code section]] (read only, contains constants, string literals, stuff initialized at compile time and that isn't changed)
